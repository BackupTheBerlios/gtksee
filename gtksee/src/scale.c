...
void
scale_region (guchar *srcPR, gint orig_width, gint orig_height, gint max_width, gint max_height, gint bytes, ScaleFunc func)
{
...
void
scale_region_preview(guchar *srcPR, gint orig_width, gint orig_height, gint max_width, gint max_height, gint bytes, ScaleFunc func)
{
